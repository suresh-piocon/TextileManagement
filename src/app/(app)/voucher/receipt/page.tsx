...
export default function ReceiptVoucherPage() {
  ...
  const loadInitialData = async () => {
    setVoucherNo(generateVoucherNo("RC"));
    fetchPastVouchers();
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { error: childError } = await supabase.from("receipt_child").insert(childItems);
      ...
      alert(error.message || "Failed to save receipt voucher");
    } finally {
      setLoading(false);
    }
  };
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input value={narration} onChange={e => setNarration(e.target.value)} placeholder="Being cash received from..." />
          </div>
